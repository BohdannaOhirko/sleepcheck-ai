    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <Link
            href="/?chat=open"
            className="inline-flex items-center gap-3 px-10 py-5 rounded-full font-light text-lg border border-border hover:bg-accent transition-all duration-500 hover:scale-105"
          >
