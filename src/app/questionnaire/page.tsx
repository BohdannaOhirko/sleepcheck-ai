      ...
      <div className="bg-card rounded-3xl shadow-xl border border-border p-8 sm:p-12">
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--logo-green)]/10 flex items-center justify-center mt-1">
              <svg
                className="w-4 h-4 text-[var(--logo-green)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                30 простих питань про ваш сон та самопочуття
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--logo-aqua)]/10 flex items-center justify-center mt-1">
              <svg
                className="w-4 h-4 text-[var(--logo-aqua)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Дані зберігаються у вашому акаунті
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--logo-lime)]/10 flex items-center justify-center mt-1">
              <svg
                className="w-4 h-4 text-[var(--logo-lime)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Персоналізовані рекомендації від асистента-сомнолога
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-accent/50 border border-border rounded-xl p-4 mb-8">
          <div className="flex gap-3">
            <div className="flex-shrink-0">
              <svg
                className="w-5 h-5 text-[var(--logo-default)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <p>
                ...
                оцінити ризики, але остаточний діагноз встановлює тільки лікар.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="group relative block w-full">
            ...
            <button
              onClick={handleStart}
              className="relative w-full px-8 py-4 rounded-xl font-semibold text-lg bg-gradient-to-r from-[var(--logo-green)] via-[var(--logo-lime)] to-[var(--logo-bright)] text-white shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]"
            >
