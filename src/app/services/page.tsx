...
const services = [
  {
    ...
    description:
      "Нічне дослідження з реєстрацією основних показників: дихання, рівень кисню в крові, положення тіла, рухи, активність мозку.",
    features: [
      "Тривалість: 6-8 годин",
      "Комфортна палата",
      "Результати через 3-5 днів",
    ],
    price: 9800,
  ...
  },
  {
    ...
    description:
      "Включає всі параметри базового дослідження + розширений аналіз структури сну, рухів кінцівок, ЕКГ моніторинг.",
  ...
  },
  {
    ...
    description:
      "Повне дослідження сну вночі + тест множинної латентності сну (MSLT) вдень. Діагностує нарколепсію.",
    features: [
      "Нічна + денний тест",
      "Діагностика нарколепсії",
      "Повний день у клініці",
    ],
    price: 18800,
  ...
  },
  {
    ...
    subtitle: "Очний або онлайн прийом спеціаліста",
    description:
      "Детальна консультація з досвідченим лікарем-сомнологом. Аналіз симптомів, план обстеження та лікування.",
    ...
    <div className="min-h-screen bg-[#f8faf9]">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-5">
            ...
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg, var(--logo-green), var(--logo-aqua))",
              }}
            >
              діагностика сну
            </span>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 leading-relaxed mb-4">
                Безкоштовна онлайн-анкета з AI-аналізом. Первинна оцінка ризиків
                за 5 хвилин.
              </p>
      ...
      <section className="pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl border border-gray-100 p-6 text-left sm:text-center">
            <p className="text-sm text-gray-400 leading-relaxed">
              <span className="font-semibold text-gray-600">
                Важлива інформація:
              </span>{" "}
              Ціни актуальні на травень 2026 року та можуть змінюватись.
              Уточнюйте вартість за телефоном або через форму запису.
            </p>
          </div>
        </div>
      </section>
