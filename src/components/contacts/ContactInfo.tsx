export default function ContactInfo() {
  const contacts = [
    { icon: "📍", title: "Адреса", content: "м. Львів, вул. Угорська, 17" },
    {
      icon: "📞",
      title: "Телефон",
      content: "+38 (098) 881 4499",
      link: "tel:+380988814499",
      sub: "+38 (098) 881 4499 (мобільний)",
    },
    {
      icon: "✉️",
      title: "Email",
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground font-light leading-relaxed mb-6">
                Спеціалізуємось на діагностиці та лікуванні розладів сну.
            ...
            <div className="space-y-6">
              {contacts.map((item, index) => (
                <div
                  key={index}
                  className="group flex gap-4 items-start transition-all duration-500 hover:translate-x-2"
                >
