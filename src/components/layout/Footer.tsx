      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
            <Image src="/images/logo.svg" alt="Ехокор" width={180} height={48} className="mb-4" />
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <p className="text-base font-bold mb-5" style={{ color: 'var(--logo-green)' }}>
              Навігація
            </p>
          ...
          {/* Послуги */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <p className="text-base font-bold mb-5" style={{ color: 'var(--logo-default)' }}>
              Послуги
            </p>
            <ul className="space-y-3">
              {[
          ...
          {/* Контакти */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <p className="text-base font-bold mb-5" style={{ color: 'var(--logo-aqua)' }}>
              Контакти
            </p>
            <ul className="space-y-3 w-full">
              <li>
                <a href="tel:+380988814499"
                  ...
                  <span className="w-7 h-7 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center text-xs flex-shrink-0">📞</span>
                  +380 98 881 4499
                </a>
              </li>
              <li>
                <a href="mailto:info@ehokor.com.ua"
                  className="flex items-center justify-center md:justify-start gap-2.5 text-sm text-gray-500 hover:text-[var(--logo-green)] transition-colors">
                  <span className="w-7 h-7 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center text-xs flex-shrink-0">✉️</span>
                  info@ehokor.com.ua
                </a>
              </li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-6 border-t border-gray-100 gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs text-gray-400">Працюємо онлайн</span>
          </div>
        </div>
      </div>
    </footer>
